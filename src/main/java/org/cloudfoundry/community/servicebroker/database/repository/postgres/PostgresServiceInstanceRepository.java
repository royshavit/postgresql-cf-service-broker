...
@Slf4j
@AllArgsConstructor
public class PostgresServiceInstanceRepository implements ServiceInstanceRepository {
    ...
    @Override
    public Optional<ServiceInstance> findServiceInstance(UUID instanceId) throws SQLException {
        Map<Integer, String> parameterMap = new HashMap<>();
        parameterMap.put(1, instanceId.toString());
